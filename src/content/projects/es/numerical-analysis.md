...
title: Análisis Numérico en C++
tagline: ¿De verdad vale la pena C++ aquí?
summary: Compara métodos numéricos — Newton-Raphson y compañía — implementados en C++ y en Python.
year: 2020
tier: archive
org: academic
tags: [misc]
tech: [C++, Python, Métodos Numéricos]
tint: panel
order: 26
status: archived
links:
